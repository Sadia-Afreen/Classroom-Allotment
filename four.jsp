<%-- 
    Document   : index2
    Created on : May 4, 2019, 12:14:19 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body bgcolor="LightGray">
     ...
     while (rs.next()) {
         ...
         if (chk.equals("X")) {
             stmt.executeUpdate("UPDATE Allocate SET " + prd + "= 'Allocated' WHERE ClassRoom = '" + clsrm + "' ");
        %><h3><% out.print(clsrm + " for " + prd + " has been allocated."); %></h3>
        <br><br>
        <h2><a href="one.jsp">return</a></h2>
        <%
        } else {
        %><h3>Already Allocated</h3><br>
        <br><br>
        <h2><a href="one.jsp">return</a></h2>
        <%
                        }
